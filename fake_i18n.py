...
MONTHS_AP = {
    1: ugettext('Jan.'), 2: ugettext('Feb.'), 3: ugettext('March'), 4: ugettext('April'), 5: ugettext('May'),
    6: ugettext('June'),
    7: ugettext('July'), 8: ugettext('Aug.'), 9: ugettext('Sept.'), 10: ugettext('Oct.'), 11: ugettext('Nov.'),
    12: ugettext('Dec.')
}
TIMESINCE = (
...
COLORNAMES = (
    ugettext('red'), ugettext('orange'), ugettext('yellow'), ugettext('green'), ugettext('teal'), ugettext('blue'),
    ugettext('purple'), ugettext('pink'),
