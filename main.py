...
app = WSGIApplication([
    ...
    PathPrefixRoute('/photos', [
        Route('/<page:\d+>', handler='views.photo.Index', name='photo_all'),
        Route('/<slug>/palette', handler='views.photo.Palette', name='palette'),
        Route('/<slug>', handler='views.photo.Detail', name='photo'),
        Route('/<field:(model|iso|eqv|lens|tags|date|author|color)>/<value>/<slug:[^\d]+>',
              handler='views.photo.Detail', name='photo_filter'),
        Route('/<field:(model|iso|eqv|lens|tags|date|author|color)>/<value>/<page:\d+>',
              handler='views.photo.Index', name='photo_filter_all'),
        ]),
    SimpleRoute(r'^/entries/?$', handler='views.entry.Index'),
    PathPrefixRoute('/entries', [
        Route('/<page:\d+>', handler='views.entry.Index', name='entry_all'),
        Route('/<field:(tags|date|author)>/<value>/<page:\d+>', handler='views.entry.Index', name='entry_filter_all'),
    ...
    PathPrefixRoute('/comments', [
        Route('/<page:\d+>', handler='views.comment.Index', name='comment_all'),
        Route('/<field:(forkind|date|author)>/<value>/<page:\d+>',
              handler='views.comment.Index', name='comment_filter_all'),
    ]),
    SimpleRoute(r'^/news/?$', handler='views.news.Index'),
    PathPrefixRoute('/news', [
        Route('/<page:\d+>', handler='views.news.Index', name='feed_all'),
        Route('/<slug>', handler='views.news.Detail', name='feed'),
        Route('/<field:tags>/<value>/<page:\d+>', handler='views.news.Index', name='feed_filter_all'),
    ]),
