...
app = WSGIApplication([
    ...
    Route(r'/api/<kind:(photo|entry)>/<safe_key>', handler='views.api.Record', methods=['GET']),
    Route(r'/api/entry/add', handler='views.api.EntryForm', methods=['POST']),
    Route(r'/api/photo/add', handler='views.api.PhotoForm', methods=['POST']),
    Route(r'/api/entry/<safe_key>', handler='views.api.EntryForm', methods=['PUT']),
    Route(r'/api/photo/<safe_key>', handler='views.api.PhotoForm', methods=['PUT']),
    ...
    Route(r'/photos/<safe_key>', handler='views.photo.Detail', name='photo'),
    Route(r'/photos/<field:(model|iso|lens|tags|date|author|color)>/<value>/<safe_key>',
          handler='views.photo.Detail', name='photo_filter'),
    Route(r'/photos/<field:(model|iso|lens|tags|date|author|color)>/<value>/',
    ...
    Route(r'/admin/photos/<safe_key>', handler='views.photo.Edit', name='photo_edit'),
    Route(r'/admin/photos/<safe_key>/palette', handler='views.photo.Palette', name='palette'),
    ...
    Route(r'/admin/entries/<safe_key>', handler='views.entry.Edit', name='entry_edit'),
