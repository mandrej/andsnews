...
app = WSGIApplication([
    ...
    Route('/admin/photos/<field:date>/<value>/', handler='views.admin.Photos', name='photo_admin_filter'),
    ...
    Route('/admin/entries/<field:date>/<value>/', handler='views.admin.Entries', name='entry_admin_filter'),
