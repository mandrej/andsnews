...
MAPPINGS = {u'š': u's', u'č': u'c', u'ć': u'c', u'ž': u'z', u'dž': u'dz', u'đ': u'dj',
            u'а': u'a', u'б': u'b', u'в': u'v', u'г': u'g', u'д': u'd', u'е': u'e', u'ж': u'z',
            u'з': u'z', u'и': u'i', u'ј': u'j', u'к': u'k', u'л': u'l', u'љ': u'lj', u'м': u'm',
            u'н': u'n', u'њ': u'nj', u'о': u'o', u'п': u'p', u'р': u'r', u'с': u's', u'т': u't',
            u'ћ': u'c', u'у': u'u', u'ф': u'f', u'х': u'h', u'ц': u'c', u'ч': u'c', u'џ': u'dz',
            u'ш': u's'}
...
def slugify(text):
    return '-'.join(word_list_replace(MAPPINGS, text.lower().split()))